...
\documentclass[
    doctor,     % 必选项：   {master, doctor} 填写学历水平
                % Mandatory: {master, doctor} Fill in the level of your degree
    academic,   % 必选项：   {academic, professional} 填写学位类型
...
\title{XXXXXXXXXXXXXXXXXXX（论文题目不能超过35个汉字）}{XXXXXXXXXX XXXXXXXX}
...
\advisor{XXX}{教授}{XXX}{(Associate)\ Prof.}
