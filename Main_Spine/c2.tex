...
\xsubsection{多张图片：引用时应该使用 subcaption 而不是 subfigure}{Use subcaption instead of subfigure}
...
\begin{texcodeonly}[]{}
  % \subfigXJTUred 及 \subfigXJTUblue 为自定义命令
  \begin{figure}[H]
    \subfigXJTUred    \subfigXJTUblue
    \floatcontinue{tb}
    \subfigXJTUblue   \subfsubfigXJTUredigg
    \subfigXJTUred    \subfigXJTUblue
    \caption{校徽}
  \end{figure}
\end{texcodeonly}
